export default function ItemCard({ src, alt, title, price }) {
  return (
    <div className="w-64 rounded-lg bg-neutral-900 p-2 hover:border-2 hover:border-solid hover:border-yellow-500">
      <img className="place-content-center rounded-lg" src={src} alt={alt} />
